...
<nav class="navbar navbar-expand-lg navbar-dark  custom-bg2">
    <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#!" data-toggle="modal" data-target="#cart"> 
                        <i class="fa fa-cart-plus"  style="font-size: 20px;"></i> <span>Cart</span><span class="ml-0 cart-items">( 0 )</span>  </a>
                </li>
                
                <li class="nav-item active">
                    <a class="nav-link" href="wallet.jsp"><ion-icon name="wallet-outline"></ion-icon> <span>Wallet</span> </a>
                </li>
